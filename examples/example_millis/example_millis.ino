...
iarduino_4LED dispLED(4,5);    //  Создаём объект для работы с функциями библиотеки iarduino_4LED, с указанием выводов дисплея ( CLK , DIO ). Можно указывать любые выводы Arduino
